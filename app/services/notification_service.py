...
class NotificationQueue:
    ...
    async def enqueue(self, notification: Notification) -> bool:
        ...
        try:
            ...
            await self.redis.zadd(
                self.QUEUE_KEY,
                {json.dumps(notification.to_dict()): score}
            )
    ...
    async def _move_to_failed(self, notification: Notification):
        ...
        try:
            ...
            logger.warning(f"Notification {notification.id} moved to failed queue after {notification.retry_count} retries")
        except Exception as e:
...
"""
    ...
    async def _send_webhook(self, notification: Notification):
        ...
        webhook_url = notification.metadata.get("webhook_url") or \
                      getattr(settings, 'custom_webhook_url', None)
